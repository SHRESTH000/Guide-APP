    ...
    <>
      ...
      <footer className="footer footer-center text-base-content rounded p-10 dark:bg-slate-900 dark:text-white">
        <nav className="flex flex-wrap justify-center gap-4">
          <a href="#" className="link link-hover hover:text-pink-500 transition duration-300">About us</a>
          <a href="#" className="link link-hover hover:text-pink-500 transition duration-300">Contact</a>
        </nav>
        <nav>
          <div className="flex justify-center gap-4 mt-4">
            {[
              ...
              <a key={index} className="hover:scale-110 transition-transform duration-300">
        ...
        <aside className="mt-6 text-center">
          <img src="public/logo.png" alt="logo" width="100px" height="100px" className="mx-auto" />
          <p className="mt-2">&copy; {new Date().getFullYear()} - All rights reserved by City Diary.</p>
        </aside>
      </footer>
    </>
  );
